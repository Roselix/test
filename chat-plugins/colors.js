...
exports.commands = {
	...
	hex: function (target, room, user) {
		...
		this.sendReplyBox('The hex code of ' + Galaxy.nameColor(targetUser, true) + ' is: <font color="' + Galaxy.hashColor(targetUser) + '"><b>' + Galaxy.hashColor(targetUser) + '</b></font>');
	},
};
...
// hashColor function
Galaxy.hashColor = function (name) {
	name = toId(name);
