...
exports.commands = {
	slots: {
		...
		spin: function (target, room, user) {
			...
			if (amount < 5) return this.errorReply('You don\'t have enough bucks to play this game. You need ' + (3 - amount) + moneyName(amount) + ' more.');
			...
			Db('money').set(user.userid, (amount - 5));
